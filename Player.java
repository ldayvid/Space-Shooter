...
public class Player extends Rectangle{
	...
	// Images
	private static final ImageIcon PLAYER_IMAGE_RIGHT= new ImageIcon("src\\Images\\Player_Right.png");
	private static final ImageIcon PLAYER_IMAGE_RIGHT2= new ImageIcon("src\\Images\\Player_Right2.png");
	private static final ImageIcon PLAYER_IMAGE_RIGHT3= new ImageIcon("src\\Images\\Player_Right3.png");
	private static final ImageIcon PLAYER_IMAGE_RIGHT4= new ImageIcon("src\\Images\\Player_Right4.png");
	private static final ImageIcon PLAYER_IMAGE_RIGHT5= new ImageIcon("src\\Images\\Player_Right5.png");
	private static final ImageIcon PLAYER_IMAGE_RIGHT6= new ImageIcon("src\\Images\\Player_Right6.png");
	private static final ImageIcon PLAYER_IMAGE_RIGHT7= new ImageIcon("src\\Images\\Player_Right7.png");
	private static final ImageIcon PLAYER_IMAGE_LEFT= new ImageIcon("src\\Images\\Player_Left.png");
	private static final ImageIcon PLAYER_IMAGE_LEFT2= new ImageIcon("src\\Images\\Player_Left2.png");
	private static final ImageIcon PLAYER_IMAGE_LEFT3= new ImageIcon("src\\Images\\Player_Left3.png");
	private static final ImageIcon PLAYER_IMAGE_LEFT4= new ImageIcon("src\\Images\\Player_Left4.png");
	private static final ImageIcon PLAYER_IMAGE_LEFT5= new ImageIcon("src\\Images\\Player_Left5.png");
	private static final ImageIcon PLAYER_IMAGE_LEFT6= new ImageIcon("src\\Images\\Player_Left6.png");
	private static final ImageIcon PLAYER_IMAGE_LEFT7= new ImageIcon("src\\Images\\Player_Left7.png");
	private static final ImageIcon PLAYER_IMAGE_JUMPR= new ImageIcon("src\\Images\\Player_JumpR.png");
	private static final ImageIcon PLAYER_IMAGE_JUMPL= new ImageIcon("src\\Images\\Player_JumpL.png");
	...
	public Bullet fire(){
		...
		if(nBoost == 0){
			...
			if(dir==0){
				return new Bullet((int)(x+width),y+30,1,30, 40, 5, 1);
			}
			return new Bullet((int)(x-width),y+30,-1,30, 40, 5, 1);
		}
		...
		// Fire big bullets
			...
			if(dir==0){
				return new BigBullet((int)(x+width),y+20,1);
			}
			return new BigBullet((int)(x-4*width),y+20, -1);
		}
	}
